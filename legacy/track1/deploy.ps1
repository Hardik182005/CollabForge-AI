# Creatrix IQ (Track 1) — deploy backend to Cloud Run + frontend to Firebase
# Run: ./deploy.ps1   (from the track1 folder)
...
Write-Host "=== Creatrix IQ (Track 1) Deploy ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== CREATRIX IQ DEPLOY COMPLETE ===" -ForegroundColor Green
